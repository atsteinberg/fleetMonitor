  ...
  return (
    ...
    <LoadScript googleMapsApiKey={process.env.REACT_APP_API_MAPS} >
      ...
      >
        ...
        {rows.map(ship=><Marker key={ship.index} icon={shipIcon} label={ship.original.shipName} position={{lat:ship.original.lat,lng:ship.original.lng}}  onclick={e=>map.panTo(e.target.position)}/>)} 
